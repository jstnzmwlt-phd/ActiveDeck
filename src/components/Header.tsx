    ...
    <div className={`p-4 bg-white border-b border-slate-200 h-14 py-1.5 relative w-full flex-shrink-0 ${(isAdminModalOpen || isExportModalOpen) ? 'z-[200]' : 'z-50'}`}>
      <div className="flex items-center justify-between relative h-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
            <h1 
              className="pointer-events-auto text-xl font-black tracking-tight text-slate-800 cursor-pointer hover:opacity-80 transition-opacity flex items-center gap-1.5"
              onClick={() => {
